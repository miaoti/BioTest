...
class TestMockedOrchestratorLoop:
    ...
    def test_all_agreeing_runners_zero_failures(self, tmp_path):
        ...
        result = run_test_suite(
            ...
            registry_path=Path("data/mr_registry.json"),
            seeds_dir=SEEDS_DIR,
    ...
    def test_disagreeing_runner_catches_all_violations(self, tmp_path):
    ...
    def test_crashing_runner_reports_all_crashes(self, tmp_path):
    ...
    def test_det_rate_exact_with_mixed_runners(self, tmp_path):
    ...
    def test_det_report_json_structure(self, tmp_path):
    ...
    def test_empty_registry_produces_zero_tests(self, tmp_path):
    ...
    def test_format_filter_restricts_tests(self, tmp_path):
