...
def main():
    ...
    log_path = out_root / "recovery_biopython_v7.log"
    ...
    try:
        for rep in REPS:
            ...
            cfg = rep_dir / f"biotest_config.recover_v7_rep{rep}.yaml"
            log(f"  writing config -> {cfg.name}", fh)
            write_config(rep, cfg)

            biotest_log = rep_dir / "biotest_recover_v7.log"
            ...
            rec = {
                ...
                "rep_kind": "recovery_v7_max_iter_2",
