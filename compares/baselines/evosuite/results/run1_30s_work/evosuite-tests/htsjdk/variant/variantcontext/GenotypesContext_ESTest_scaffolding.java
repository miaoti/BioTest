...
public class GenotypesContext_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "htsjdk.variant.variantcontext.GenotypesContext"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(GenotypesContext_ESTest_scaffolding.class.getClassLoader() ,
      "htsjdk.variant.variantcontext.Allele",
      "htsjdk.variant.variantcontext.GenotypesContext$InOrderIterator",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("htsjdk.variant.variantcontext.LazyGenotypesContext$LazyParser", false, GenotypesContext_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(GenotypesContext_ESTest_scaffolding.class.getClassLoader()); 
